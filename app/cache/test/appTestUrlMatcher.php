    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/blog')) {
            ...
            if (preg_match('#^/blog/(?P<id>\\d+)$#s', $pathinfo, $matches)) {
                ...
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'BlogBundle_blog_show')), array (  '_controller' => 'BlogFarce\\BlogBundle\\Controller\\BlogController::showAction',));
            }
            not_BlogBundle_blog_show:

            // BlogBundle_blog_show_comments
            if (preg_match('#^/blog/(?P<id>\\d+)/comments$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_BlogBundle_blog_show_comments;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'BlogBundle_blog_show_comments')), array (  '_controller' => 'BlogFarce\\BlogBundle\\Controller\\BlogController::showCommentsAction',));
            }
            not_BlogBundle_blog_show_comments:

            // BlogBundle_blog_create_comment
            if (preg_match('#^/blog/(?P<id>[^/]++)/comments/new$#s', $pathinfo, $matches)) {
                if ($this->context->getMethod() != 'POST') {
                    $allow[] = 'POST';
                    goto not_BlogBundle_blog_create_comment;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'BlogBundle_blog_create_comment')), array (  '_controller' => 'BlogFarce\\BlogBundle\\Controller\\CommentController::createAction',));
            }
            not_BlogBundle_blog_create_comment:
        ...
        if (0 === strpos($pathinfo, '/blogs')) {
            // get_blogs
            if (preg_match('#^/blogs(?:\\.(?P<_format>json|xml|html))?$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_get_blogs;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'get_blogs')), array (  '_controller' => 'BlogFarce\\ApiBundle\\Controller\\BlogController::getBlogsAction',  '_format' => NULL,));
            }
            not_get_blogs:

            // get_blog
            if (preg_match('#^/blogs/(?P<blog>[^/\\.]++)(?:\\.(?P<_format>json|xml|html))?$#s', $pathinfo, $matches)) {
                if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                    $allow = array_merge($allow, array('GET', 'HEAD'));
                    goto not_get_blog;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'get_blog')), array (  '_controller' => 'BlogFarce\\ApiBundle\\Controller\\BlogController::getBlogAction',  '_format' => NULL,));
            }
            not_get_blog:
